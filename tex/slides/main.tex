...
\begin{frame}
    ...
    \end{itemize}
    %Il sistema operativo esegue dei controlli e può capitare che interrompa programmi che in C sono legali.
...
%    \begin{enumerate}
%        \item I meccanismi di sicurezza in Rust sono modellati su un sistema di tipi lineare. 
%        È basato sulla \textbf{logica lineare} di Girard la quale permette di ragionare sul consumo di risorse.
%        \item La sicurezza in Rust è divisa concettualmente in  \textbf{memory safety} e \textbf{type safety}, sono strettamente collegate tra loro e risulta difficile definirne i confini.
%    \end{enumerate} 
%\end{frame}
...
\begin{frame}
    ...
    \lstinputlisting[language=Rust, basicstyle=\fontsize{8}{9}\selectfont]{../../code/DoubleFree/double_simple.rs}
\end{frame}
